...
<link rel="stylesheet" href="${rootPath}/static/css/index.css?ver=2020-09-24-001">
<script src="http://code.jquery.com/jquery-latest.min.js"></script>
<script>
	// js 파일에서 ${rootPath} 값을 참조하기 위해 rootPath 변수를 전역으로 선언
	var rootPath = "${rootPath}"
	// main-nav.js 파일에서 el tag 변수값을 사용할 수 없기 때문에 별도로 2개의 변수를 선언하고, 각각 headerName과 token 값을 저장
