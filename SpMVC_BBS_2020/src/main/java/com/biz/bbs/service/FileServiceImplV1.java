...
public class FileServiceImplV1 implements FileService {
	...
	/*
	 * BbsController의 write POST에서 파일을 수신한 후 이곳으로 전달하여 실제 서버에 파일을 복사하는 코드 생성
	 */
	public String fileUp(MultipartFile file) {
		// 파일 이름 추출
		String fileName=file.getOriginalFilename();
		
		// tomcat server의 home 디렉토리
		...
		// 이미 있거나 생성된 tmpFolder와 업로드할 파일 이름을 연결해 파일 정보로 생성
