...
public class NaverSecretSample {
	...
	/*
	 * 네이버 Open API 등록을 수행한 후 Client ID와 Client Secret을 복사하여 등록하고,
	 * 이 클래스를 NaverSecret으로 변경하여 프로젝트를 수행하시오.
	 */
	public final static String NAVER_CLIENT_ID="YOUR NAVER CLIENT ID";
	public final static String NAVER_CLIENT_SECRET="YOUR NAVER SECRET ID";
